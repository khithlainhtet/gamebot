...
For speed, this bot matches from an in-memory snapshot cache instead of querying MongoDB for every lookup."""
...
NOT_FOUND = "🇬🇧 Not found. This media may not exist in the database yet."
